...
const renderToc = async (tocBlocks, slot, tocId, uuid, parentPage) => {
  ...
  return `<div class="tocBoard" data-slot-id="${tocId}" data-toc-id="${tocId}"><h2 class="toc">${logseq.settings.tocTitle} <i data-on-click="openInRightSidebar" class="ti ti-arrow-bar-right"></i></h2>${html}</div>`;
};
